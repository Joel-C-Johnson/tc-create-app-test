...
<head>
    <title>Code coverage report for plain-text-check.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> plain-text-check.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>69/110</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>68/89</span>
            </div>
...
<span class="cline-any cline-yes">14598x</span>
<span class="cline-any cline-yes">13956x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">13956x</span>
<span class="cline-any cline-yes">1383396x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1383396x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">72x</span>
<span class="cline-any cline-yes">1383324x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        const resultObject = <span class="cstat-no" title="statement not covered" >checkTextField(languageCode, repoCode, textType, '', fieldText, allowedLinks, optionalFieldLocation, checkingOptions);</span>
&nbsp;
...
&nbsp;
    function <span class="fstat-no" title="function not covered" >checkPlainLineContents(</span>lineNumber, lineText, lineLocation) {
&nbsp;
        // functionLog(`checkPlainLineContents for '${lineName}', '${lineText}' at${lineLocation}`);
        let thisText = <span class="cstat-no" title="statement not covered" >lineText.trimStart();</span> // So we don’t get "leading space" AND "doubled spaces" errors
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (thisText)</span>
            // Allow links as that’s more general
<span class="cstat-no" title="statement not covered" >            ourCheckTextField(lineNumber, thisText, true, lineLocation, checkingOptions);</span>
    }
    // end of checkPlainLineContents function
&nbsp;
&nbsp;
    // Main code for checkPlainText function
    <span class="missing-if-branch" title="if path not taken" >I</span>if (isWhitespace(plainText)) {
<span class="cstat-no" title="statement not covered" >        addNotice({ priority: 638, message: "Only found whitespace", location: ourLocation });</span>
<span class="cstat-no" title="statement not covered" >        return cptResult;</span>
    }
&nbsp;
    let characterIndex;
    <span class="missing-if-branch" title="if path not taken" >I</span>if ((characterIndex = plainText.indexOf('&lt;&lt;&lt;&lt;&lt;&lt;&lt;')) &gt;= 0) {
        ...
        const excerpt = <span class="cstat-no" title="statement not covered" >(iy &gt; excerptHalfLength ? '…' : '') + plainText.substring(iy - excerptHalfLength, iy + excerptHalfLengthPlus).replace(/ /g, '␣') + (iy + excerptHalfLengthPlus &lt; plainText.length ? '…' : '')</span>
<span class="cstat-no" title="statement not covered" >        addNotice({ priority: 993, message: "Unresolved GIT conflict", characterIndex, excerpt, location: ourLocation });</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if ((characterIndex = plainText.indexOf('=======')) &gt;= 0) {
        const iy = <span class="cstat-no" title="statement not covered" >characterIndex + excerptHalfLength;</span> // Want excerpt to focus more on what follows
        const excerpt = <span class="cstat-no" title="statement not covered" >(iy &gt; excerptHalfLength ? '…' : '') + plainText.substring(iy - excerptHalfLength, iy + excerptHalfLengthPlus).replace(/ /g, '␣') + (iy + excerptHalfLengthPlus &lt; plainText.length ? '…' : '')</span>
<span class="cstat-no" title="statement not covered" >        addNotice({ priority: 992, message: "Unresolved GIT conflict", characterIndex, excerpt, location: ourLocation });</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if ((characterIndex = plainText.indexOf('&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;')) &gt;= 0) {
        const iy = <span class="cstat-no" title="statement not covered" >characterIndex + excerptHalfLength;</span> // Want excerpt to focus more on what follows
        const excerpt = <span class="cstat-no" title="statement not covered" >(iy &gt; excerptHalfLength ? '…' : '') + plainText.substring(iy - excerptHalfLength, iy + excerptHalfLengthPlus).replace(/ /g, '␣') + (iy + excerptHalfLengthPlus &lt; plainText.length ? '…' : '')</span>
<span class="cstat-no" title="statement not covered" >        addNotice({ priority: 991, message: "Unresolved GIT conflict", characterIndex, excerpt, location: ourLocation });</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (plainText[0] === '\n') {
<span class="cstat-no" title="statement not covered" >        characterIndex = 0;</span>
        const excerpt = <span class="cstat-no" title="statement not covered" >(plainText.length &gt; excerptLength ? '…' : '') + plainText.slice(-excerptLength).replace(/ /g, '␣').replace(/\n/g, '\\n')</span>
<span class="cstat-no" title="statement not covered" >        addNotice({ priority: 539, message: "File starts with empty line", characterIndex, excerpt, location: ourLocation });</span>
    }
    if (!plainText.endsWith('\n') &amp;&amp; !textName.endsWith('title.md')) {
        characterIndex = plainText.length - 1;
        const excerpt = (plainText.length &gt; excerptLength ? '…' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + plainText.slice(-excerptLength).replace(/ /g, '␣').replace(/\n/g, '\\n')
...
&nbsp;
        ...
        if (line) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (textType === 'text' || textType === 'raw') // other file-types do these checks themselves
<span class="cstat-no" title="statement not covered" >                checkPlainLineContents(n, line, ourLocation);</span>
&nbsp;
                ...
                if (PAIRED_PUNCTUATION_OPENERS.indexOf(char) &gt;= 0) {
                    ...
                    if (openMarkers.length) {
                        ...
                        if (lastEntry.char === PAIRED_PUNCTUATION_OPENERS.charAt(closeCharacterIndex)) {
                            ...
                            <span class="missing-if-branch" title="else path not taken" >E</span>if (char !== '’' // Closing single quote is also used as apostrophe in English
                                &amp;&amp; (textType !== 'markdown' || <span class="branch-2 cbranch-no" title="branch not covered" >char !== '&gt;' </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >characterIndex &gt; 4)</span>) { // Markdown uses &gt; or &gt;&gt; or &gt; &gt; or &gt; &gt; &gt; for block indents so ignore these -- might just be consequential error
                                const excerpt = (characterIndex &gt; excerptHalfLength ? '…' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + line.substring(characterIndex - excerptHalfLength, characterIndex + excerptHalfLengthPlus).replace(/ /g, '␣') + (characterIndex + excerptHalfLengthPlus &lt; line.length ? <span class="branch-0 cbranch-no" title="branch not covered" >'…' </span>: '')
...
&nbsp;
    ...
    if (openMarkers.length) {
        ...
        const line = lines[n - 1];
        const excerpt = (x &gt; excerptHalfLength ? '…' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span> + line.substring(x - excerptHalfLength, x + excerptHalfLengthPlus).replace(/ /g, '␣') + (x + excerptHalfLengthPlus &lt; line.length ? '…' : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>
        const details = openMarkers.length &gt; 1 ? `${openMarkers.length} unclosed set${openMarkers.length === 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: 's'}` : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
...
&nbsp;
    addSuccessMessage(`Checked all ${lines.length.toLocaleString()} line${lines.length === 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: 's'}${ourLocation}.`);
    if (cptResult.noticeList.length)
        addSuccessMessage(`checkPlainText v${PLAIN_TEXT_VALIDATOR_VERSION_STRING} finished with ${cptResult.noticeList.length ? cptResult.noticeList.length.toLocaleString() : <span class="branch-1 cbranch-no" title="branch not covered" >"zero"}</span> notice${cptResult.noticeList.length === 1 ? '' : 's'}`);
    else
