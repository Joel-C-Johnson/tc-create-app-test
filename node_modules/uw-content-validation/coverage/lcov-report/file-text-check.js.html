...
<head>
    <title>Code coverage report for file-text-check.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> file-text-check.js</h1>
        <div class='clearfix'>
...
&nbsp;
    function addNotice(noticeObject) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (noticeObject.debugChain) <span class="cstat-no" title="statement not covered" >noticeObject.debugChain = `checkTextfileContents(${languageCode}, ${fileType}, ${filename}) ${noticeObject.debugChain}`;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!fileText) // Nothing to check
