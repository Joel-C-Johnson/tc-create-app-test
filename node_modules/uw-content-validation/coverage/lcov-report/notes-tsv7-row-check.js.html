...
<head>
    <title>Code coverage report for notes-tsv7-row-check.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> notes-tsv7-row-check.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">86.52% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>154/178</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>122/165</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>148/171</span>
            </div>
...
<a name='L524'></a><a href='#L524'>524</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    */
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (givenC) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (givenV) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ourRowLocation &amp;&amp; ourRowLocation[0] !== ' ') ourRowLocation = ` ${ourRowLocation}`;
&nbsp;
...
&nbsp;
        const fieldType = fieldName === 'Note' ? <span class="branch-0 cbranch-no" title="branch not covered" >'markdown' </span>: 'raw';
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (bookID === 'OBS')
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (C.length) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (C === 'front') { }
            else if (/^\d+$/.test(C)) {
                let intC = Number(C);
...
<span class="cstat-no" title="statement not covered" >                    haveGoodChapterNumber = false;</span>
                ...
                else <span class="missing-if-branch" title="if path not taken" >I</span>if (intC &gt; numChaptersThisBook) {
...
<span class="cstat-no" title="statement not covered" >                    haveGoodChapterNumber = false;</span>
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (lowercaseBookID === 'obs')
<span class="cstat-no" title="statement not covered" >                    numVersesThisChapter = 99; </span>// Set to maximum expected number of frames
                    ...
                    try {
                        ...
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (!haveGoodBookID)
...
<span class="cstat-no" title="statement not covered" >            addNoticePartial({ priority: 820, message: "Missing chapter number", rowID, fieldName: 'Reference', location: ` ?:${V}${ourRowLocation}` });</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 811, message: "Bad verse number", rowID, fieldName: 'Reference', location: ` '${V}'${ourRowLocation}` });</span>
        }
        else
...
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 373, message: "Field is only whitespace", fieldName: 'SupportReference', rowID, location: ourRowLocation });</span>
            else <span class="missing-if-branch" title="else path not taken" >E</span>if (repoCode === 'TN2') { // More than just whitespace
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (checkingOptions?.disableAllLinkFetchingFlag !== true)
            ...
            let characterIndex;
            <span class="missing-if-branch" title="if path not taken" >I</span>if ((characterIndex = supportReference.indexOf('\u200B') !== -1)) {
                const charCount = <span class="cstat-no" title="statement not covered" >countOccurrences(supportReference, '\u200B');</span>
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 374, message: "Field contains zero-width space(s)", details: `${charCount} occurrence${charCount === 1 ? '' : 's'} found`, fieldName: 'SupportReference', characterIndex, rowID, location: ourRowLocation });</span>
            }
        }
...
&nbsp;
        if (occurrence.length) { // This should usually be a digit
            if (occurrence === '0') { // zero means that it doesn’t occur
                <span class="missing-if-branch" title="if path not taken" >I</span>if (quote.length) {
...
<span class="cstat-no" title="statement not covered" >                    OSuggestion = '1';</span>
            ...
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (occurrence === '-1') { } // TODO check the special conditions when this can occur???
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (quote.length) {
...
&nbsp;
        if (note.length) {
            if (note.indexOf('&lt;br&gt;') &gt;= 0) {
                ...
                addNoticePartial({ priority: 674, message: "Field contains HTML &lt;br&gt; field(s)", details: `${charCount} occurrence${charCount === 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: 's'} found—should be '\\n' instead`, fieldName: 'Note', rowID, location: ourRowLocation });
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (note.indexOf('\u200B') &gt;= 0) {
                const charCount = <span class="cstat-no" title="statement not covered" >countOccurrences(note, '\u200B');</span>
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 374, message: "Field contains zero-width space(s)", details: `${charCount} occurrence${charCount === 1 ? '' : 's'} found`, fieldName: 'Note', rowID, location: ourRowLocation });</span>
            }
            if (isWhitespace(note))
                ...
                while ((regexResultArray = TA_REGEX.exec(adjustedNote))) {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (adjustedLink === supportReference) <span class="cstat-no" title="statement not covered" >foundSR = true;</span>
                }
                if (linksList.length &amp;&amp; V !== 'intro') {
                    let details = supportReference ? `SR='${supportReference}'` : <span class="branch-1 cbranch-no" title="branch not covered" >"empty SR field"</span>
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (foundSR) {
<span class="cstat-no" title="statement not covered" >                        if (linksList.length &gt; 1)</span>
<span class="cstat-no" title="statement not covered" >                            addNoticePartial({ priority: 786, message: "Shouldn’t have multiple TA links in Note", details, rowID, fieldName: 'OccurrenceNote', excerpt, location: ourRowLocation });</span>
                    } else // didn't find SR
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (repoCode === 'TN2')
...
&nbsp;
        ...
        const suggestion = `${reference}\t${RIDSuggestion === undefined ? rowID : RIDSuggestion}\t${tags}\t${SRSuggestion === undefined ? supportReference : <span class="branch-1 cbranch-no" title="branch not covered" >SRSuggestion}</span>\t${QSuggestion === undefined ? quote : QSuggestion}\t${OSuggestion === undefined ? occurrence : OSuggestion}\t${ASuggestion === undefined ? note : <span class="branch-1 cbranch-no" title="branch not covered" >ASuggestion}</span>`;
        if (suggestion !== line) {
