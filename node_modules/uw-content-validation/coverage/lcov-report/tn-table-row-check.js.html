...
<head>
    <title>Code coverage report for tn-table-row-check.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> tn-table-row-check.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">83.33% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>210/252</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>132/186</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>202/238</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { DEFAULT_EXTRACT_LENGTH, isWhitespace, countOccurrences } from './text-handling-functions'
...
&nbsp;
    ...
    */
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (givenC) parameterAssert(typeof givenC === 'string', `checkTN_TSVDataRow: 'givenC' parameter should be a string not a '${typeof givenC}'`);
    // parameterAssert(givenV !== undefined, "checkTN_TSVDataRow: 'givenV' parameter should be defined");
    <span class="missing-if-branch" title="else path not taken" >E</span>if (givenV) parameterAssert(typeof givenV === 'string', `checkTN_TSVDataRow: 'givenV' parameter should be a string not a '${typeof givenV}'`);
...
&nbsp;
        ...
        parameterAssert(allowedLinks === true || <span class="branch-1 cbranch-no" title="branch not covered" >allowedLinks === false,</span> "checkTN_TSVDataRow ourMarkdownTextChecks: allowedLinks parameter must be either true or false");
...
&nbsp;
        ...
        for (const noticeEntry of omtcResultObject.noticeList) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (noticeEntry.priority !== 178 &amp;&amp; noticeEntry.priority !== 179 // unexpected space after ellipse, ellipse after space
...
&nbsp;
        const fieldType = fieldName === 'OccurrenceNote' ? <span class="branch-0 cbranch-no" title="branch not covered" >'markdown' </span>: 'raw';
...
&nbsp;
        ...
        for (const coqNoticeEntry of coqResultObject.noticeList) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (coqNoticeEntry.extra) // it must be an indirect check on a TA or TW article from a TN2 check
<span class="cstat-no" title="statement not covered" >                drResult.noticeList.push(coqNoticeEntry); </span>// Just copy the complete notice as is
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coqResultObject.checkedFileCount &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >coqResultObject.checkedFileCount &gt; 0)</span>
<span class="cstat-no" title="statement not covered" >            if (typeof drResult.checkedFileCount === 'number') <span class="cstat-no" title="statement not covered" >drResult.checkedFileCount += coqResultObject.checkedFileCount;</span></span>
            else <span class="cstat-no" title="statement not covered" >drResult.checkedFileCount = coqResultObject.checkedFileCount;</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coqResultObject.checkedFilesizes &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >coqResultObject.checkedFilesizes &gt; 0)</span>
<span class="cstat-no" title="statement not covered" >            if (typeof drResult.checkedFilesizes === 'number') <span class="cstat-no" title="statement not covered" >drResult.checkedFilesizes += coqResultObject.checkedFilesizes;</span></span>
            else <span class="cstat-no" title="statement not covered" >drResult.checkedFilesizes = coqResultObject.checkedFilesizes;</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coqResultObject.checkedRepoNames &amp;&amp; coqResultObject.checkedRepoNames.length &gt; 0)
<span class="cstat-no" title="statement not covered" >            for (const checkedRepoName of coqResultObject.checkedRepoNames)</span>
<span class="cstat-no" title="statement not covered" >                try { <span class="cstat-no" title="statement not covered" >if (drResult.checkedRepoNames.indexOf(checkedRepoName) &lt; 0) <span class="cstat-no" title="statement not covered" >drResult.checkedRepoNames.push(checkedRepoName); </span></span>}</span>
                catch { <span class="cstat-no" title="statement not covered" >drResult.checkedRepoNames = [checkedRepoName]; </span>}
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coqResultObject.checkedFilenameExtensions &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >coqResultObject.checkedFilenameExtensions.length &gt; 0)</span>
<span class="cstat-no" title="statement not covered" >            for (const checkedFilenameExtension of coqResultObject.checkedFilenameExtensions)</span>
<span class="cstat-no" title="statement not covered" >                try { <span class="cstat-no" title="statement not covered" >if (drResult.checkedFilenameExtensions.indexOf(checkedFilenameExtension) &lt; 0) <span class="cstat-no" title="statement not covered" >drResult.checkedFilenameExtensions.push(checkedFilenameExtension); </span></span>}</span>
                catch { <span class="cstat-no" title="statement not covered" >drResult.checkedFilenameExtensions = [checkedFilenameExtension]; </span>}
...
<span class="cstat-no" title="statement not covered" >        addNoticePartial({ priority: 979, message: "Invalid book identifier passed to checkTN_TSVDataRow", location: ` '${bookID}' in first parameter: ${tlcNCerror}` });</span>
    }
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (B.length) {
            if (B !== bookID)
...
<span class="cstat-no" title="statement not covered" >            addNoticePartial({ priority: 977, message: "Missing book identifier", characterIndex: 0, rowID, location: ourRowLocation });</span>
&nbsp;
        let numVersesThisChapter, haveGoodChapterNumber;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (C.length) {
            if (C !== givenC)
...
<span class="cstat-no" title="statement not covered" >                    addNoticePartial({ priority: 824, message: `Invalid zero chapter number`, extract: C, rowID, fieldName: 'Chapter', location: ourRowLocation });</span>
<span class="cstat-no" title="statement not covered" >                    haveGoodChapterNumber = false;</span>
                ...
                try {
                    ...
                    <span class="missing-if-branch" title="if path not taken" >I</span>if (!haveGoodBookID)
                        // addNoticePartial({priority:500, "Invalid chapter number", rowLocation);
                        // else
<span class="cstat-no" title="statement not covered" >                        addNoticePartial({ priority: 822, message: "Unable to check chapter number", extract: C, rowID, fieldName: 'Chapter', location: ourRowLocation });</span>
                    haveGoodChapterNumber = false;
                }
            }
            else
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 821, message: "Bad chapter number", extract: C, rowID, fieldName: 'Chapter', location: ourRowLocation });</span>
        }
        else
<span class="cstat-no" title="statement not covered" >            addNoticePartial({ priority: 820, message: "Missing chapter number", rowID, fieldName: 'Chapter', location: ` ?:${V}${ourRowLocation}` });</span>
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (V.length) {
            if (V !== givenV)
            ...
            if (bookID === 'OBS' || V === 'intro') { }
                ...
                let intV = Number(V);
                <span class="missing-if-branch" title="if path not taken" >I</span>if (intV === 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >bookID !== 'PSA')</span> // Psalms have \d as verse zero
<span class="cstat-no" title="statement not covered" >                    addNoticePartial({ priority: 814, message: "Invalid zero verse number", rowID, fieldName: 'Verse', extract: V, location: ourRowLocation });</span>
                else {
                    if (haveGoodChapterNumber) {
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (intV &gt; numVersesThisChapter)
<span class="cstat-no" title="statement not covered" >                            addNoticePartial({ priority: 813, message: "Invalid large verse number", rowID, fieldName: 'Verse', extract: V, location: ourRowLocation });</span>
                    } else
                        addNoticePartial({ priority: 812, message: "Unable to check verse number", rowID, fieldName: 'Verse', location: ourRowLocation });
                }
            }
            else
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 811, message: "Bad verse number", rowID, fieldName: 'Verse', location: ` '${V}'${ourRowLocation}` });</span>
        }
        else
<span class="cstat-no" title="statement not covered" >            addNoticePartial({ priority: 810, message: "Missing verse number", rowID, fieldName: 'Verse', location: ` after ${C}:?${ourRowLocation}` });</span>
&nbsp;
        if (!rowID.length)
            ...
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (LC_ALPHABET.indexOf(rowID[0]) &lt; 0)
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 176, message: "Row ID should start with a lowercase letter", characterIndex: 0, rowID, fieldName: 'ID', extract: rowID, location: ourRowLocation });</span>
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (LC_ALPHABET_PLUS_DIGITS.indexOf(rowID[3]) &lt; 0)
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 175, message: "Row ID should end with a lowercase letter or digit", characterIndex: 3, rowID, fieldName: 'ID', extract: rowID, location: ourRowLocation });</span>
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (LC_ALPHABET_PLUS_DIGITS_PLUS_HYPHEN.indexOf(rowID[1]) &lt; 0)
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 174, message: "Row ID characters should only be lowercase letters, digits, or hypen", fieldName: 'ID', characterIndex: 1, rowID, extract: rowID, location: ourRowLocation });</span>
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (LC_ALPHABET_PLUS_DIGITS_PLUS_HYPHEN.indexOf(rowID[2]) &lt; 0)
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 173, message: "Row ID characters should only be lowercase letters, digits, or hypen", fieldName: 'ID', characterIndex: 2, rowID, extract: rowID, location: ourRowLocation });</span>
        }
&nbsp;
        if (supportReference.length) { // need to check TN2 against TA
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isWhitespace(supportReference))
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 373, message: "Field is only whitespace", fieldName: 'SupportReference', rowID, location: ourRowLocation });</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (supportReference.indexOf('\u200B') &gt;= 0) {
                const charCount = <span class="cstat-no" title="statement not covered" >countOccurrences(supportReference, '\u200B');</span>
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 374, message: "Field contains zero-width space(s)", details: `${charCount} occurrence${charCount === 1 ? '' : 's'} found`, fieldName: 'SupportReference', rowID, location: ourRowLocation });</span>
            }
        }
...
&nbsp;
        if (occurrence.length) { // This should usually be a digit
            if (occurrence === '0') { // zero means that it doesn’t occur
                <span class="missing-if-branch" title="if path not taken" >I</span>if (origQuote.length) {
<span class="cstat-no" title="statement not covered" >                    addNoticePartial({ priority: 751, message: "Invalid zero occurrence field when we have an original quote", fieldName: 'Occurrence', rowID, extract: occurrence, location: ourRowLocation });</span>
<span class="cstat-no" title="statement not covered" >                    OSuggestion = '1';</span>
        ...
        else <span class="missing-if-branch" title="else path not taken" >E</span>if (origQuote.length) {
...
&nbsp;
        if (GLQuote.length) { // TODO: need to check UTN against ULT
            <span class="missing-if-branch" title="if path not taken" >I</span>if (GLQuote.indexOf('\u200B') &gt;= 0) {
                const charCount = <span class="cstat-no" title="statement not covered" >countOccurrences(GLQuote, '\u200B');</span>
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 374, message: "Field contains zero-width space(s)", details: `${charCount} occurrence${charCount === 1 ? '' : 's'} found`, fieldName: 'GLQuote', rowID, location: ourRowLocation });</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (isWhitespace(GLQuote))
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 373, message: "Field is only whitespace", fieldName: 'GLQuote', rowID, location: ourRowLocation });</span>
            else // More than just whitespace
                <span class="missing-if-branch" title="else path not taken" >E</span>if (V !== 'intro')
...
&nbsp;
        if (occurrenceNote.length) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (occurrenceNote.indexOf('\u200B') &gt;= 0) {
                const charCount = <span class="cstat-no" title="statement not covered" >countOccurrences(occurrenceNote, '\u200B');</span>
<span class="cstat-no" title="statement not covered" >                addNoticePartial({ priority: 374, message: "Field contains zero-width space(s)", details: `${charCount} occurrence${charCount === 1 ? '' : 's'} found`, fieldName: 'OccurrenceNote', rowID, location: ourRowLocation });</span>
            }
...
&nbsp;
        ...
        const suggestion = `${B}\t${C}\t${V}\t${RIDSuggestion === undefined ? rowID : RIDSuggestion}\t${SRSuggestion === undefined ? supportReference : <span class="branch-1 cbranch-no" title="branch not covered" >SRSuggestion}</span>\t${OQSuggestion === undefined ? origQuote : OQSuggestion}\t${OSuggestion === undefined ? occurrence : OSuggestion}\t${GLQSuggestion === undefined ? GLQuote : <span class="branch-1 cbranch-no" title="branch not covered" >GLQSuggestion}</span>\t${ONSuggestion === undefined ? occurrenceNote : ONSuggestion}`;
        if (suggestion !== line) {
