...
<head>
    <title>Code coverage report for tn-tsv9-row-check.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> tn-tsv9-row-check.js</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>132/166</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { DEFAULT_EXCERPT_LENGTH } from './defaults';
...
&nbsp;
    ...
    */
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (givenC) { //parameterAssert(typeof givenC === 'string', `checkTN_TSV9DataRow: 'givenC' parameter should be a string not a '${typeof givenC}'`);
    }
    // //parameterAssert(givenV !== undefined, "checkTN_TSV9DataRow: 'givenV' parameter should be defined");
    <span class="missing-if-branch" title="else path not taken" >E</span>if (givenV) { //parameterAssert(typeof givenV === 'string', `checkTN_TSV9DataRow: 'givenV' parameter should be a string not a '${typeof givenV}'`);
    }
...
<span class="cstat-no" title="statement not covered" >                    addNoticePartial({ priority: 824, message: `Invalid zero chapter number`, excerpt: C, rowID, fieldName: 'Chapter', location: ourRowLocation });</span>
...
<span class="cstat-no" title="statement not covered" >                    addNoticePartial({ priority: 814, message: "Invalid zero verse number", rowID, fieldName: 'Verse', excerpt: V, location: ourRowLocation });</span>
                else {
                    if (haveGoodChapterNumber) {
                        <span class="missing-if-branch" title="if path not taken" >I</span>if (intV &gt; numVersesThisChapter)
<span class="cstat-no" title="statement not covered" >                            addNoticePartial({ priority: 813, message: "Invalid large verse number", details: `${bookID} chapter ${C} only has ${numVersesThisChapter} verses`, rowID, fieldName: 'Verse', excerpt: V, location: ourRowLocation });</span>
                    } else
