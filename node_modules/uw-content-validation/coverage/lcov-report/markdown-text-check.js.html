...
<head>
    <title>Code coverage report for markdown-text-check.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> markdown-text-check.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">62.5% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>90/144</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>82/146</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">67.18% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>88/131</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3444x</span>
<span class="cline-any cline-yes">3444x</span>
<span class="cline-any cline-yes">3444x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (textOrFileName === `${languageCode}_${repoCode.toLowerCase()}`) { <span class="cstat-no" title="statement not covered" >console.trace('checkMarkdownText()'); </span>}
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (checkingOptions !== undefined) { //parameterAssert(typeof checkingOptions === 'object', `checkMarkdownText: 'checkingOptions' parameter should be an object not a '${typeof checkingOptions}': ${JSON.stringify(checkingOptions)}`);
    }
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (textOrFileName === 'README.md' || textOrFileName === 'LICENSE.md') <span class="cstat-no" title="statement not covered" >adjustedTextOrFileName = textOrFileName.substring(0, textOrFileName.length - 3);</span>
...
<span class="cstat-no" title="statement not covered" >                result.noticeList.push(coqNoticeEntry); </span>// Just copy the complete notice as is -- would be confusing to have this lineNumber
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coTNlResultObject.checkedFileCount &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >coTNlResultObject.checkedFileCount &gt; 0)</span>
<span class="cstat-no" title="statement not covered" >            if (typeof result.checkedFileCount === 'number') <span class="cstat-no" title="statement not covered" >result.checkedFileCount += coTNlResultObject.checkedFileCount;</span></span>
            else <span class="cstat-no" title="statement not covered" >result.checkedFileCount = coTNlResultObject.checkedFileCount;</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coTNlResultObject.checkedFilesizes &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >coTNlResultObject.checkedFilesizes &gt; 0)</span>
<span class="cstat-no" title="statement not covered" >            if (typeof result.checkedFilesizes === 'number') <span class="cstat-no" title="statement not covered" >result.checkedFilesizes += coTNlResultObject.checkedFilesizes;</span></span>
            else <span class="cstat-no" title="statement not covered" >result.checkedFilesizes = coTNlResultObject.checkedFilesizes;</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coTNlResultObject.checkedRepoNames &amp;&amp; coTNlResultObject.checkedRepoNames.length &gt; 0)
<span class="cstat-no" title="statement not covered" >            for (const checkedRepoName of coTNlResultObject.checkedRepoNames)</span>
<span class="cstat-no" title="statement not covered" >                try { <span class="cstat-no" title="statement not covered" >if (result.checkedRepoNames.indexOf(checkedRepoName) &lt; 0) <span class="cstat-no" title="statement not covered" >result.checkedRepoNames.push(checkedRepoName); </span></span>}</span>
                catch { <span class="cstat-no" title="statement not covered" >result.checkedRepoNames = [checkedRepoName]; </span>}
        <span class="missing-if-branch" title="if path not taken" >I</span>if (coTNlResultObject.checkedFilenameExtensions &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >coTNlResultObject.checkedFilenameExtensions.length &gt; 0)</span>
<span class="cstat-no" title="statement not covered" >            for (const checkedFilenameExtension of coTNlResultObject.checkedFilenameExtensions)</span>
<span class="cstat-no" title="statement not covered" >                try { <span class="cstat-no" title="statement not covered" >if (result.checkedFilenameExtensions.indexOf(checkedFilenameExtension) &lt; 0) <span class="cstat-no" title="statement not covered" >result.checkedFilenameExtensions.push(checkedFilenameExtension); </span></span>}</span>
                catch { <span class="cstat-no" title="statement not covered" >result.checkedFilenameExtensions = [checkedFilenameExtension]; </span>}
...
<span class="cstat-no" title="statement not covered" >            thisText = thisText.replace(/^&gt;+ */g, '');</span>
...
&nbsp;
        let suggestion;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (thisText &amp;&amp; lineText[0] !== '|') // Doesn’t really make sense to check table line entries
...
&nbsp;
        ...
        if (line.startsWith('#')) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (n &gt; 1 &amp;&amp; lastLine.length !== 0) {
                const notice = <span class="cstat-no" title="statement not covered" >{ priority: 252, message: "Markdown headers should be preceded by a blank line", lineNumber: n, location: ourLocation };</span>
<span class="cstat-no" title="statement not covered" >                if (textOrFileName === 'Note' || textOrFileName === 'OccurrenceNote')</span>
<span class="cstat-no" title="statement not covered" >                    notice.details = `markdown line ${n}`;</span>
<span class="cstat-no" title="statement not covered" >                addNotice(notice);</span>
            }
            if (nextLine?.length !== 0) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (textOrFileName === 'Note' || <span class="branch-1 cbranch-no" title="branch not covered" >textOrFileName === 'OccurrenceNote')</span>
...
&nbsp;
        ...
        if (line) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (thisHeaderLevel &gt; headerLevel + 1
                &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!textOrFileName.startsWith('TA '))</span> { // Suppress this notice for translationAcademy subsections
                const notice = <span class="cstat-no" title="statement not covered" >{ priority: 172, message: "Header levels should only increment by one", lineNumber: n, characterIndex: 0, location: ourLocation };</span>
<span class="cstat-no" title="statement not covered" >                if (textOrFileName === 'Note' || textOrFileName === 'OccurrenceNote')</span>
<span class="cstat-no" title="statement not covered" >                    notice.details = `markdown line ${n}`;</span>
<span class="cstat-no" title="statement not covered" >                addNotice(notice);</span>
            }
...
&nbsp;
            ...
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (numLeadingSpaces &lt; previousIndentLevel) { // We have an indent level decrease
<span class="cstat-no" title="statement not covered" >                if (indentLevels.length &gt; 1 &amp;&amp; indentLevels[indentLevels.length - 2] === numLeadingSpaces)</span>
                    // We went back to the previous level
<span class="cstat-no" title="statement not covered" >                    indentLevels.pop();</span>
                else { // seems we didn't go back to the previous level ???
                    let foundPreviousLevel = <span class="cstat-no" title="statement not covered" >false;</span>
<span class="cstat-no" title="statement not covered" >                    for (let z = <span class="cstat-no" title="statement not covered" >indentLevels.length - 1;</span> z &gt;= 0; z--) {</span>
<span class="cstat-no" title="statement not covered" >                        if (indentLevels[z] === numLeadingSpaces) {</span>
                            // debugLog(`After finding ${numLeadingSpaces} spaces, reducing length of ${JSON.stringify(indentLevels)} to ${z+1}`);
<span class="cstat-no" title="statement not covered" >                            indentLevels.length = z + 1;</span>
<span class="cstat-no" title="statement not covered" >                            foundPreviousLevel = true;</span>
<span class="cstat-no" title="statement not covered" >                            break;</span>
                        }
                    }
<span class="cstat-no" title="statement not covered" >                    if (!foundPreviousLevel) {</span>
                        const notice = <span class="cstat-no" title="statement not covered" >{ priority: 282, message: "Nesting of header levels seems confused", details: `recent indent levels=${JSON.stringify(indentLevels)} but now ${numLeadingSpaces}`, lineNumber: n, characterIndex: 0, location: ourLocation };</span>
<span class="cstat-no" title="statement not covered" >                        if (textOrFileName === 'Note' || textOrFileName === 'OccurrenceNote')</span>
<span class="cstat-no" title="statement not covered" >                            notice.details = `markdown line ${n}`;</span>
<span class="cstat-no" title="statement not covered" >                        addNotice(notice);</span>
                    }
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (n &gt; 1 &amp;&amp; lastLine.length === 0 &amp;&amp; nextLine?.length === 0 &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >!notifiedBlankLines)</span> {
                const notice = <span class="cstat-no" title="statement not covered" >{ priority: 250, message: "Multiple blank lines are not expected in markdown", lineNumber: n, location: ourLocation };</span>
<span class="cstat-no" title="statement not covered" >                if (textOrFileName === 'Note' || textOrFileName === 'OccurrenceNote')</span>
<span class="cstat-no" title="statement not covered" >                    notice.details = `markdown line ${n}`;</span>
<span class="cstat-no" title="statement not covered" >                addNotice(notice);</span>
<span class="cstat-no" title="statement not covered" >                notifiedBlankLines = true;</span>
            }
        }
&nbsp;
        lastLine = line;
...
&nbsp;
    ...
    for (const thisSet of [ // Put longest ones first
        ...
        const count = ((markdownText || <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>.match(thisRegex) || []).length; // Finds only NON-OVERLAPPING matches hopefully
        <span class="missing-if-branch" title="if path not taken" >I</span>if (count &amp;&amp; (count % 2) !== 0) {
            const characterIndex = <span class="cstat-no" title="statement not covered" >markdownText.indexOf(thisField);</span>
            const iy = <span class="cstat-no" title="statement not covered" >characterIndex + excerptHalfLength;</span> // Want excerpt to focus more on what follows
            const excerpt = /*(iy &gt; excerptHalfLength ? '…' : '') +*/ <span class="cstat-no" title="statement not covered" >markdownText.substring(iy - excerptHalfLength, iy + excerptHalfLengthPlus) + (iy + excerptHalfLengthPlus &lt; markdownText.length ? '…' : '')</span>
<span class="cstat-no" title="statement not covered" >            addNotice({ priority: 378, message: `Possible mismatched '${thisField}' markdown formatting pairs`, details: `${count.toLocaleString()} total occurrence${count === 1 ? '' : 's'}`, characterIndex, excerpt, location: ourLocation });</span>
<span class="cstat-no" title="statement not covered" >            break; </span>// Only want one warning per text
        }
    }
&nbsp;
...
&nbsp;
    ...
    if (result.noticeList.length)
        addSuccessMessage(`checkMarkdownText v${MARKDOWN_TEXT_VALIDATOR_VERSION_STRING} finished with ${result.noticeList.length ? result.noticeList.length.toLocaleString() : <span class="branch-1 cbranch-no" title="branch not covered" >"zero"}</span> notice${result.noticeList.length === 1 ? '' : 's'}`);
    else
